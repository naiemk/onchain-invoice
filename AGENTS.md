...
- It uses the **Commerce** contracts (`contracts/commerce/`) and `CommerceInvoiceSdk` for EVM; Nile uses `deriveTronInvoiceAddress` + sponsor sweep (no commerce Tron contracts yet).
