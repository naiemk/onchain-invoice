export const FASTSWAP_RECEIVER_ABI = [
  ...
  "function aggregateAll(address token,address aggregator,bytes callData) returns (bytes)",
  "function setAggregatorAllowed(address aggregator,bool allowed)",
  "function aggregatorAllowed(address aggregator) view returns (bool)",
