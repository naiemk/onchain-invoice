...
export type WalletTab = "home" | "security" | "send" | "receive" | "create" | "pair";
...
export function walletSubnav(current: WalletTab): string {
  const links = [
    { href: "/wallet", key: "home" as const, label: t("wallet.homeTab") },
    { href: "/wallet/send", key: "send" as const, label: t("wallet.sendTitle") },
    { href: "/wallet/receive", key: "receive" as const, label: t("wallet.receiveTitle") },
    { href: "/wallet/security", key: "security" as const, label: t("wallet.devicesTab") },
  ];
  return `
