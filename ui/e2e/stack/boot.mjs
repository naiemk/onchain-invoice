...
const apiEnv = {
  ...
  IDENTITY_STORE_ADDRESS: stack.storeAddress,
  IDENTITY_WALLET_FACTORY_ADDRESS: stack.factoryAddress,
  IDENTITY_WALLET_IMPLEMENTATION: stack.implementationAddress,
  IDENTITY_SESSION_SECRET: "e2e-identity-session",
  IDENTITY_DEV_OTP: "1",
  RESEND_API_KEY: "",
  WALLET_CHAIN_ID: "11155111",
  WALLET_RECOVERY_TIMELOCK: "1",
